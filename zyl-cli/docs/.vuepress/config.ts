...
export default defineConfig4CustomTheme({
  ...
  base: '/fe-spec/',
	themeConfig: {
		...
		repo: 'zhengyalizyl/web-zhuawa',
		searchMaxSuggestions: 10,
		docsDir: 'docs',
		footer: {
			createYear: 2023,
			copyrightInfo:
				'encode studio | <a href="https://github.com/zhengyalizyl/web-zhuawa" target="_blank">github</a>',
		},

		extendFrontmatter: {
			author: {
				name: 'zyl',
				link: 'https://github.com/zhengyalizyl/web-zhuawa',
			},
		},
	},
