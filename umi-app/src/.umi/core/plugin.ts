...
import * as Plugin_1 from '/Volumes/F/zyl-study/web-zhuawa/umi-app/src/.umi/plugin-qiankun-slave/slaveRuntimePlugin.ts';
...
export function getPlugins() {
  return [
    ...
    {
      apply: Plugin_1,
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Volumes/F/zyl-study/web-zhuawa/umi-app/src/.umi/plugin-qiankun-slave/slaveRuntimePlugin.ts',
    },
  ];
}
