...
import { NavLink, NavLinkProps, NavLinkRenderProps, useLocation, useNavigate } from 'react-router-dom'
import Search from '../search';
import { BellIcon } from '@heroicons/react/24/outline';

const Logo = () => <div className='px-2'>
  <svg viewBox="0 0 64 30" 
    fill="#1772F6" width="64" 
    height="30" className="css-1hlrcxk">
